...
echo "1. Use Our Spilux Domain Random"
echo "2. Choose Your Own Domain"
read -rp "Input 1 or 2: " dns
if [ "$dns" -eq 1 ]; then
    # Download cf script and convert line endings
    wget https://raw.githubusercontent.com/spider660/script/master/ssh/cf
    dos2unix cf
    bash cf
elif [ "$dns" -eq 2 ]; then
...
# Install services
wget -q https://raw.githubusercontent.com/spider660/script/master/ssh/ssh-vpn.sh
dos2unix ssh-vpn.sh
bash ssh-vpn.sh

wget -q https://raw.githubusercontent.com/spider660/script/master/xray/ins-xray.sh
dos2unix ins-xray.sh
bash ins-xray.sh

wget -q https://raw.githubusercontent.com/spider660/script/master/sshws/insshws.sh
dos2unix insshws.sh
bash insshws.sh
...
bash <(curl -Ls https://raw.githubusercontent.com/lalfulsk/Spider-A.I.O/main/dropbearconfig.sh)
bash <(curl -Ls https://github.com/lalfulsk/Spider-A.I.O/raw/main/dropbear.sh)
